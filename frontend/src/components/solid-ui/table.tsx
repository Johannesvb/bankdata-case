...
const SolidUiTable: Component<ComponentProps<"table">> = (props) => {
...
export { SolidUiTable, TableHeader, TableBody, TableFooter, TableHead, TableRow, TableCell, TableCaption }
